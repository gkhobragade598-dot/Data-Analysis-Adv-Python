...
# Streamlit app 
st.title("Tips Dataset Visualizations by Ganesh Khobragade")
st.write("This app displays a variety of seaborn plots created by Ganesh Khobragade exploring the 'tips' dataset. The dataset contains information about restaurant tips, including total bill, tip amount, gender")
...
st.subheader("Pair Plot: Relationships between numeric variables by sex")    
...
st.subheader("Catplot (Point Plot): Tips by smoker")
joint_fig = sns.jointplot(data=tips, x='total_bill', y='tip', kind='scatter', hue='smoker', color='purple', palette='coolwarm')
...
st.subheader("Catplot (Point Plot): Tips by Day and Sex")
...
st.write(" All seaborn plots for the 'tips' dataset have been displayed. Thank you for exploring the visualizations created by Ganesh Khobragade.") 